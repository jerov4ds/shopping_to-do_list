            ...
            <div class="row" style="margin-top: 5em">
                <div class="col-6">
                    <div class="my-8 p-3 bg-white rounded shadow-sm">
                        <h6 class="border-bottom border-gray pb-2 mb-0">My To-do Lists <button class="btn btn-xs btn-primary" title="Create todo list" onclick="createList('todo')">+</button></h6>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <div class="overflow-hidden flex-nowrap">
                                                    <h6 class="mb-1">
                                                        <a href="#!" class="text-reset">{{ $list->title }}</a>
                                                    </h6>
                ...
                <div class="col-6">
                    <div class="my-8 p-3 bg-white rounded shadow-sm" style="min-height: 50vh">
                        <h6 class="border-bottom border-gray pb-2 mb-0">Shopping Lists</h6>
